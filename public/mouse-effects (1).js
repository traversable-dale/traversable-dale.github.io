...
function initBoldTextGlow() {
  const boldElements = document.querySelectorAll('strong, b');
  const magneticRange = 30; // ADJUST THIS - max distance for magnetic effect (pixels)
  const magneticStrength = 1.5; // ADJUST THIS - how strong the pull is (0.1 = subtle, 0.5 = strong)
